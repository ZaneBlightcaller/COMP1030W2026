namespace Module3
{
    ...
    */
             ...
             * ToString()
             *two variables (item) and (price)
             *30 dots per item and price
             *
             */
            ...
            Console.WriteLine($"{item1}{line2dotLeader}{price2String}");
            Console.WriteLine($"{item1}{line3dotLeader}{price3String}");
