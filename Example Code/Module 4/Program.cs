    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (hour > 5)
                ...
                Console.WriteLine($"It is {hour} 0' clock and it is time to wake up!");
            
            else
            
                Console.WriteLine($"It is {hour} 0' clock. Go back to sleep");
            ...
            if (calculateSum == 0.3)
                Console.WriteLine("It is true that 0.1 + 0.2 is equal to 0.3");
            else
            ...
            if (yourName == "blight")
            {
                ...
                Console.WriteLine($"Hello, {yourName}, you are doing great today");
                bool myVar = true;
